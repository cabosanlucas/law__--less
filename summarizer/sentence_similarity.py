...
# described in the paper and how I implemented it. implementation form Sujit Pal
# can be found here
...
def compute_similarity(sentence_1, sentence_2, info_content_norm):
    """
    Calculate the semantic similarity between two sentences. The last
    parameter is True or False depending on whether information content
    normalization is desired or not.
    """
    sem =  DELTA * semantic_similarity(sentence_1, sentence_2, info_content_norm)
    dist =     (1.0 - DELTA) * word_order_similarity(sentence_1, sentence_2)
    return dist + sem
